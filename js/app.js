...
import TopLeftCorner from "../assets/top_left_corner.png";
import TopRightCorner from "../assets/top_right_corner.png";
import BottomLeftCorner from "../assets/bottom_left_corner.png";
import BottomRightCorner from "../assets/bottom_right_corner.png";
...
function preload() {
    ...
    this.load.image('top_left_corner', TopLeftCorner);
    this.load.image('top_right_corner', TopRightCorner);
    this.load.image('bottom_left_corner', BottomLeftCorner);
    this.load.image('bottom_right_corner', BottomRightCorner);
